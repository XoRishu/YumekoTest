...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="Oᴡɴᴇʀ Iɴғᴏ", url=f"https://t.me/CuteRishu/3"),
    ],
]
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Oᴡɴᴇʀ](https://t.me/CuteEneru) ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ [Sᴜᴩᴩᴏʀᴛ Cʜᴀᴛ](https://t.me/kanao_support) ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text=":)",
                            callback_data="https://t.me/CuteEneru/3",
                        ),
                    ],
                    [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text=":(",
                            callback_data="https://t.me/CuteRishu",
                        ),
                    ],
                    [
...
{BOT_NAME} Oᴡɴᴇʀ Is [Rishu](https://t.me/CuteRishu).
© 2022 - 2023 [kanao_support](https://t.me/{SUPPORT_CHAT}), Aʟʟ Rɪɢʜᴛs Rᴇsᴇʀᴠᴇᴅ.
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1904355959 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» Tʜᴇ Dᴇᴠᴇʟᴏᴩᴇʀ Oғ {BOT_NAME} Sᴏʀᴄᴇ Cᴏᴅᴇ Is [Rishu](https://t.me/CuteRishu)."
                f"\n\nʙᴜᴛ Yᴏᴜ Cᴀɴ Aʟsᴏ Dᴏɴᴀᴛᴇ Tᴏ Tʜᴇ Pᴇʀsᴏɴ Cᴜʀʀᴇɴᴛʟʏ Rᴜɴɴɪɴɢ Mᴇ : [Rishu](https://t.me/CuteRishu)",
                parse_mode=ParseMode.MARKDOWN,
                disable_web_page_preview=True,
            )
...
❆ [Oᴡɴᴇʀ Iɴғᴏ](https://t.me/CuteRishu/3)""",
               parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
